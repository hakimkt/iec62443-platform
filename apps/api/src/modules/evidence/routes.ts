...
export async function evidenceRoutes(app: FastifyInstance, options: EvidenceRouteOptions) {
  const { db } = options;
  ...
  app.post(
    '/evidence',
    {
      schema: {
        ...
        description:
          'Creates a new evidence item (metadata-only, no file upload). Requires authentication.',
        security: [{ bearerAuth: [] }],
        body: {
          type: 'object',
  ...
  app.post(
    '/evidence/:id/upload',
    {
      schema: {
        ...
        description:
          'Uploads a file and attaches it to an existing evidence item. Computes SHA-256 hash for integrity verification. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
  ...
  app.patch(
    '/evidence/:id',
    {
      schema: {
        ...
        description:
          'Updates an evidence item (title, description, tags only). Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
  ...
  app.delete(
    '/evidence/:id',
    {
      schema: {
        ...
        description:
          'Deletes an evidence item. Cannot delete if linked to active entities. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
  ...
  app.post(
    '/evidence/:id/links',
    {
      schema: {
        ...
        description:
          'Links evidence to a domain entity (finding, assessment, risk, csms_element). Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
  ...
  app.delete(
    '/evidence/:id/links/:linkId',
    {
      schema: {
        ...
        description:
          'Removes a link between evidence and a domain entity. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id', 'linkId'],
  ...
  app.get(
    '/evidence/:id/chain-of-custody',
    {
      schema: {
        ...
        description:
          'Returns chain of custody events for an evidence item. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
  ...
  app.get(
    '/evidence/:id/verify',
    {
      schema: {
        ...
        description:
          'Verifies evidence integrity by checking the SHA-256 hash. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
