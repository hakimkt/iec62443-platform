...
export async function assessmentRoutes(app: FastifyInstance, options: AssessmentRouteOptions) {
  const { db } = options;
  ...
  app.patch(
    '/assessments/:id',
    {
      schema: {
        ...
        description:
          'Updates an assessment engagement. Only draft or in_progress engagements can be updated. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
  ...
  app.delete(
    '/assessments/:id',
    {
      schema: {
        ...
        description:
          'Soft-deletes a draft assessment engagement by setting status to archived. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
  ...
  app.get(
    '/assessments/:id/questions',
    {
      schema: {
        ...
        description:
          'Returns all questions for an assessment engagement along with any existing responses. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
  ...
  app.post(
    '/assessments/:id/responses',
    {
      schema: {
        ...
        description:
          'Submits or updates a response to a question within an assessment. Upserts if a response already exists. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
  ...
  app.get(
    '/assessments/:id/scorecard',
    {
      schema: {
        tags: ['Assessment'],
        summary: 'Get assessment scorecard',
        description:
          'Computes and returns the scorecard for an assessment engagement, grouped by section. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
  ...
  app.get(
    '/assessments/:id/progress',
    {
      schema: {
        ...
        description:
          'Returns the completion progress for an assessment engagement. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
