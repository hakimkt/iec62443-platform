...
export async function assetRoutes(app: FastifyInstance, options: AssetRouteOptions) {
  const { db } = options;
  ...
  app.get(
    '/assets',
    {
      schema: {
        ...
        summary: 'List assets',
        description:
          'Returns a paginated list of assets with optional filters. Requires authentication.',
        security: [{ bearerAuth: [] }],
        querystring: {
          type: 'object',
          properties: {
            ...
            operationalStatus: {
              type: 'string',
              enum: ['operational', 'maintenance', 'decommissioned', 'standby'],
            },
  ...
  app.get(
    '/assets/stats',
    {
      schema: {
        ...
        description:
          'Returns aggregate counts of assets by type, criticality, and total. Requires authentication.',
        security: [{ bearerAuth: [] }],
        response: {
          200: responseSchema,
        },
  ...
  app.post(
    '/assets/import',
    {
      schema: {
        ...
        description:
          'Creates a new import job record for bulk asset import. Requires authentication.',
        security: [{ bearerAuth: [] }],
        body: {
          type: 'object',
  ...
  app.delete(
    '/assets/:id',
    {
      schema: {
        ...
        description:
          'Soft-deletes an asset by setting operationalStatus to decommissioned. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
  ...
  app.post(
    '/assets/:id/relationships',
    {
      schema: {
        ...
        description:
          'Creates a relationship between this asset and a target asset. Requires authentication.',
        security: [{ bearerAuth: [] }],
        params: {
          type: 'object',
          required: ['id'],
        ...
        body: {
          ...
          properties: {
            ...
            relationshipType: {
              type: 'string',
              enum: ['communicates_with', 'depends_on', 'controls', 'monitored_by', 'connected_to'],
            },
