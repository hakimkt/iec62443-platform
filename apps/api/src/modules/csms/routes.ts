...
export async function csmsRoutes(
  app: FastifyInstance,
  options: CSMSRouteOptions,
) {
  const { db } = options;
  ...
  app.post('/csms/frameworks/:frameworkId/elements', {
    schema: {
      tags: ['CSMS'],
  ...
  app.post('/csms/frameworks/:frameworkId/policies', {
    schema: {
      tags: ['CSMS'],
  ...
  app.post('/csms/policies/:id/approve', {
    schema: {
      tags: ['CSMS'],
  ...
  app.get('/csms/frameworks/:frameworkId/improvement-plans', {
    schema: {
      tags: ['CSMS'],
  ...
  app.post('/csms/frameworks/:frameworkId/improvement-plans', {
    schema: {
      tags: ['CSMS'],
  ...
  app.get('/csms/frameworks/:id/gap-analysis', {
    schema: {
      tags: ['CSMS'],
