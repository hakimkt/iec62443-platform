...
export class RemediationService {
  ...
  async deletePlan(id: string, userId: string) {
    ...
    await this.db.delete(remediationPlans).where(eq(remediationPlans.id, id));
  ...
  async createAction(planId: string, data: CreateActionInput, userId: string) {
    ...
    return this.getAction(newAction.id);
  }
  ...
  async deleteAction(id: string, userId: string) {
    ...
    await this.db.delete(remediationActions).where(eq(remediationActions.id, id));
