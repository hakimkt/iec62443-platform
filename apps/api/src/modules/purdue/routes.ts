...
export async function purdueRoutes(app: FastifyInstance, options: PurdueRouteOptions) {
  const { db } = options;
  ...
  app.patch(
    '/purdue-models/:id/levels/:levelId',
    {
      schema: {
        tags: ['Purdue'],
  ...
  app.delete(
    '/purdue-models/:id/mappings/:assetId',
    {
      schema: {
        tags: ['Purdue'],
