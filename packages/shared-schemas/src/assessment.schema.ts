import { z } from 'zod';
import { iecPartSchema, securityLevelSchema, uuidSchema } from './common.schema.js';
...
export const maturityLevelSchema = z.enum(['implemented', 'partial', 'not_implemented', 'na']);
