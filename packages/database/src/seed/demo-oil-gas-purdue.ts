...
const NEW_ZONES = [
  ...
  },
  {
    ...
    description: 'SCADA servers, historians, and operator workstations. Purdue Level 3.',
    zoneType: 'manufacturing_ops',
    securityLevel: 2,
    targetSl: 3,
    achievedSl: 2,
...
const L5_ASSETS: AssetDef[] = [
  {
    ...
    net: 'IT-CORP-VLAN50',
    purdueLevel: 5,
    zoneId: '72000000-0000-0000-0000-000000000001',
  ...
  },
  {
    ...
    type: 'server',
    crit: 'safety_critical',
    vendor: 'Microsoft',
    model: 'Windows Server 2022 DC',
    fw: 'KB5034441',
    ip: '10.1.5.13',
    net: 'IT-CORP-VLAN50',
    purdueLevel: 5,
  ...
  {
    id: '82000000-0000-0000-0000-000000000006',
  ...
  {
    id: '82000000-0000-0000-0000-000000000007',
    name: 'VPN Gateway',
  ...
  {
    id: '82000000-0000-0000-0000-000000000012',
  ...
  {
    id: '82000000-0000-0000-0000-000000000013',
  ...
  {
    id: '82000000-0000-0000-0000-000000000014',
    name: 'IT Asset Management Server',
  ...
  {
    id: '82000000-0000-0000-0000-000000000015',
    name: 'Corporate Network Switch',
...
const L4_ASSETS: AssetDef[] = [
  {
    id: '82000000-0000-0000-0000-000000000016',
    name: 'MES Server',
    ...
    net: 'IT-BUS-VLAN40',
    purdueLevel: 4,
    zoneId: '72000000-0000-0000-0000-000000000002',
    loc: 'IT Server Room, Building 12',
    meta: { os: 'Windows Server 2022', patchLevel: '2026-Q1' },
  },
  {
    id: '82000000-0000-0000-0000-000000000017',
    name: 'LIMS Server',
  ...
  },
  {
    ...
    crit: 'operational',
    vendor: 'AVEVA',
    model: 'Engineering Document Management 14.1',
    fw: '14.1.2',
    ip: '10.1.4.15',
    net: 'IT-BUS-VLAN40',
    purdueLevel: 4,
  ...
  {
    id: '82000000-0000-0000-0000-000000000022',
  ...
  {
    id: '82000000-0000-0000-0000-000000000023',
    name: 'Regulatory Reporting Server',
  ...
  {
    id: '82000000-0000-0000-0000-000000000024',
    name: 'Maintenance Management Server',
  ...
  {
    id: '82000000-0000-0000-0000-000000000025',
    name: 'Environmental Monitoring Server',
    ...
    crit: 'business_critical',
    vendor: 'ABB',
    model: 'Ability Environmental Monitoring 2.1',
    fw: '2.1.4',
    ip: '10.1.4.19',
    net: 'IT-BUS-VLAN40',
    purdueLevel: 4,
  ...
  {
    id: '82000000-0000-0000-0000-000000000026',
    name: 'OT Historian Replica',
  ...
  {
    id: '82000000-0000-0000-0000-000000000027',
    name: 'Workstation — Plant Manager',
  ...
  {
    id: '82000000-0000-0000-0000-000000000028',
    name: 'Workstation — Production Planner',
  ...
  {
    id: '82000000-0000-0000-0000-000000000029',
    name: 'Workstation — Lab Manager',
  ...
  {
    id: '82000000-0000-0000-0000-000000000030',
    name: 'Workstation — Scheduler',
  ...
  {
    id: '82000000-0000-0000-0000-000000000031',
    name: 'Supply Chain Management Server',
  ...
  {
    id: '82000000-0000-0000-0000-000000000032',
    name: 'Business Planning Switch',
  ...
  {
    id: '82000000-0000-0000-0000-000000000033',
    name: 'Workstation — Reliability Engineer',
  ...
  {
    id: '82000000-0000-0000-0000-000000000034',
    name: 'Blending Optimization Server',
  ...
  {
    id: '82000000-0000-0000-0000-000000000035',
    name: 'Workstation — Turnaround Planner',
...
const L3_5_ASSETS: AssetDef[] = [
  {
    id: '82000000-0000-0000-0000-000000000036',
    name: 'Data Diode',
  ...
  {
    id: '82000000-0000-0000-0000-000000000037',
  ...
  {
    id: '82000000-0000-0000-0000-000000000038',
    name: 'AV Update Server',
  ...
  {
    id: '82000000-0000-0000-0000-000000000039',
    name: 'WSUS Server',
  ...
  {
    id: '82000000-0000-0000-0000-000000000041',
    name: 'OPC UA Gateway',
  ...
  {
    id: '82000000-0000-0000-0000-000000000042',
    name: 'Log Forwarder',
  ...
  {
    id: '82000000-0000-0000-0000-000000000043',
    name: 'Time Sync Server (iDMZ)',
  ...
  {
    id: '82000000-0000-0000-0000-000000000044',
    name: 'Network Tap',
...
const L3_ASSETS: AssetDef[] = [
  {
    id: '82000000-0000-0000-0000-000000000045',
    name: 'Operator Workstation — CDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000046',
    name: 'Operator Workstation — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000047',
    name: 'Operator Workstation — HDS',
  ...
  {
    id: '82000000-0000-0000-0000-000000000048',
    name: 'Operator Workstation — Sulfur Unit',
  ...
  {
    id: '82000000-0000-0000-0000-000000000049',
    name: 'DCS Controller — Main',
  ...
  {
    id: '82000000-0000-0000-0000-000000000050',
    name: 'DCS Controller — Backup',
    ...
    meta: {
      os: 'Honeywell proprietary RTOS',
      redundancy: 'hot_standby_primary',
      controlLoops: 240,
      patchLevel: '2026-Q1',
    },
  },
  {
    id: '82000000-0000-0000-0000-000000000051',
    ...
    crit: 'safety_critical',
    vendor: 'Honeywell',
    model: 'Dynamic Alarm Manager R510',
    fw: 'R510.6',
    ip: '10.10.2.52',
    net: 'OT-SCADA-VLAN20',
    purdueLevel: 2,
  ...
  {
    id: '82000000-0000-0000-0000-000000000052',
    name: 'OPC UA Server',
  ...
  {
    id: '82000000-0000-0000-0000-000000000053',
    name: 'RTDB Server',
  ...
  {
    id: '82000000-0000-0000-0000-000000000054',
    name: 'Anti-Surge Controller',
  ...
  {
    id: '82000000-0000-0000-0000-000000000055',
    name: 'Data Historian Gateway',
  ...
  {
    id: '82000000-0000-0000-0000-000000000056',
    name: 'Operations Firewall',
    ...
    meta: {
      os: 'FortiOS 7.4',
      dpiEnabled: true,
      industrialProtocolInspection: ['Modbus/TCP', 'PROFINET'],
      patchLevel: '2026-Q1',
    },
  },
  {
    id: '82000000-0000-0000-0000-000000000057',
  ...
  {
    id: '82000000-0000-0000-0000-000000000058',
    name: 'Control Room Display — CDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000059',
    name: 'Control Room Display — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000060',
    name: 'Operator Workstation — Tank Farm',
  ...
  {
    id: '82000000-0000-0000-0000-000000000061',
    name: 'Operator Workstation — Utilities',
  ...
  {
    id: '82000000-0000-0000-0000-000000000062',
    name: 'Surge Vessel Monitor',
  ...
  {
    id: '82000000-0000-0000-0000-000000000063',
    name: 'Control Room Display — Utilities',
  ...
  {
    id: '82000000-0000-0000-0000-000000000064',
    name: 'Operator Workstation — Hydrocracker',
  ...
  {
    id: '82000000-0000-0000-0000-000000000065',
    name: 'Operator Workstation — Reformer',
...
const L2_ASSETS: AssetDef[] = [
  {
    id: '82000000-0000-0000-0000-000000000066',
    name: 'Area HMI — CDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000068',
    name: 'Area HMI — Hydrocracker',
  ...
  {
    id: '82000000-0000-0000-0000-000000000069',
    name: 'Area HMI — Reformer',
  ...
  {
    id: '82000000-0000-0000-0000-000000000070',
    name: 'Area HMI — Alkylation',
  ...
  {
    id: '82000000-0000-0000-0000-000000000071',
    name: 'Area HMI — Tank Farm',
  ...
  {
    id: '82000000-0000-0000-0000-000000000072',
    name: 'Area HMI — Utilities',
  ...
  {
    id: '82000000-0000-0000-0000-000000000074',
    name: 'Local Operator Panel — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000075',
    name: 'Local Operator Panel — Hydrocracker',
  ...
  {
    id: '82000000-0000-0000-0000-000000000076',
    name: 'Data Concentrator — North',
  ...
  {
    id: '82000000-0000-0000-0000-000000000077',
    name: 'Data Concentrator — South',
  ...
  {
    id: '82000000-0000-0000-0000-000000000078',
    name: 'Data Concentrator — Tank Farm',
    desc: 'Data concentrator aggregating tank level and custody transfer data from the tank farm RTUs.',
    type: 'gateway',
    crit: 'business_critical',
    vendor: 'ABB',
    model: 'AC500-S CPU PM592-S',
    fw: 'V3.4.1',
    ip: '10.10.2.112',
    net: 'OT-SUP-VLAN25',
    purdueLevel: 2,
  ...
  {
    id: '82000000-0000-0000-0000-000000000080',
    name: 'Motor Control Center — Area 2',
  ...
  {
    id: '82000000-0000-0000-0000-000000000081',
    name: 'Motor Control Center — Area 3',
  ...
  {
    id: '82000000-0000-0000-0000-000000000083',
    name: 'VFD — Group B',
  ...
  {
    id: '82000000-0000-0000-0000-000000000084',
    name: 'VFD — Group C',
  ...
  {
    id: '82000000-0000-0000-0000-000000000085',
    name: 'Area Network Switch — North',
  ...
  {
    id: '82000000-0000-0000-0000-000000000086',
    name: 'Area Network Switch — South',
  ...
  {
    id: '82000000-0000-0000-0000-000000000087',
    name: 'Local Operator Panel — Reformer',
  ...
  {
    id: '82000000-0000-0000-0000-000000000088',
    name: 'Local Operator Panel — Alkylation',
  ...
  {
    id: '82000000-0000-0000-0000-000000000089',
    name: 'Local Operator Panel — Tank Farm',
  ...
  {
    id: '82000000-0000-0000-0000-000000000090',
    name: 'Supervisory PLC — CDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000091',
    name: 'Supervisory PLC — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000092',
    name: 'Supervisory PLC — Hydrocracker',
  ...
  {
    id: '82000000-0000-0000-0000-000000000093',
    name: 'Supervisory PLC — Reformer',
  ...
  {
    id: '82000000-0000-0000-0000-000000000094',
    name: 'Supervisory PLC — Alkylation',
    desc: 'Supervisory PLC providing sequence control and interlock logic for the Alkylation Unit.',
    type: 'plc',
    crit: 'business_critical',
    vendor: 'Schneider',
    model: 'Modicon M580 CPU P580204',
    fw: 'V3.60',
    ip: '10.10.2.126',
    net: 'OT-SUP-VLAN25',
    purdueLevel: 2,
  ...
  {
    id: '82000000-0000-0000-0000-000000000095',
    name: 'Supervisory PLC — Utilities',
...
const L1_ASSETS: AssetDef[] = [
  {
    id: '82000000-0000-0000-0000-000000000096',
    name: 'Allen-Bradley ControlLogix PLC — CDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000097',
    name: 'Allen-Bradley ControlLogix PLC — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000098',
    name: 'Siemens S7-1500 PLC — Hydrocracker',
  ...
  },
  {
    ...
    name: 'Siemens S7-1500 PLC — Reformer',
  ...
  {
    id: '82000000-0000-0000-0000-000000000100',
    name: 'Schneider Modicon M580 PLC — Alkylation',
  ...
  {
    id: '82000000-0000-0000-0000-000000000101',
    name: 'Schneider Modicon M580 PLC — Tank Farm',
  ...
  {
    id: '82000000-0000-0000-0000-000000000102',
    name: 'ABB AC500 PLC — Utilities',
  ...
  {
    id: '82000000-0000-0000-0000-000000000103',
    name: 'ABB AC500 PLC — Sulfur Unit',
  ...
  {
    id: '82000000-0000-0000-0000-000000000104',
    name: 'Safety PLC — Burner Management',
  ...
  {
    id: '82000000-0000-0000-0000-000000000105',
    name: 'Safety PLC — Emergency Shutdown',
    ...
    crit: 'safety_critical',
    vendor: 'Siemens',
    model: 'SIMATIC S7-1500F CPU 1518-4',
    fw: 'V2.9.2',
    ip: '10.10.1.41',
    net: 'OT-SIS-VLAN15',
    purdueLevel: 1,
  ...
  {
    id: '82000000-0000-0000-0000-000000000106',
    name: 'Safety PLC — Fire & Gas',
  ...
  {
    id: '82000000-0000-0000-0000-000000000107',
    name: 'Emerson DeltaV Controller — CDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000108',
    name: 'Emerson DeltaV Controller — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000109',
    name: 'Honeywell C300 Controller — Hydrocracker',
  ...
  {
    id: '82000000-0000-0000-0000-000000000110',
    name: 'Honeywell C300 Controller — Reformer',
  ...
  {
    id: '82000000-0000-0000-0000-000000000111',
    name: 'Yokogawa CENTUM Controller — Alkylation',
    desc: 'Yokogawa CENTUM VP controller providing advanced regulatory control for the alkylation unit.',
    type: 'dcs_controller',
    crit: 'safety_critical',
    vendor: 'Yokogawa',
    model: 'CENTUM VP R6.09',
    fw: 'R6.09.10',
    ip: '10.10.1.47',
    net: 'OT-PLC-VLAN10',
    purdueLevel: 1,
  ...
  {
    id: '82000000-0000-0000-0000-000000000112',
    name: 'Yokogawa CENTUM Controller — Tank Farm',
  ...
  {
    id: '82000000-0000-0000-0000-000000000113',
    name: 'VFD — Crude Charge Pump',
  ...
  {
    id: '82000000-0000-0000-0000-000000000114',
    name: 'VFD — Vacuum Heater Feed',
    desc: 'Variable frequency drive controlling the vacuum heater feed pump.',
    type: 'vfd',
    crit: 'safety_critical',
    vendor: 'ABB',
    model: 'ACS880-01-120A-3',
    fw: '2.10.4',
    ip: '10.10.1.51',
    net: 'OT-PLC-VLAN10',
    purdueLevel: 1,
  ...
  {
    id: '82000000-0000-0000-0000-000000000115',
    name: 'VFD — Hydrocracker Charge',
  ...
  {
    id: '82000000-0000-0000-0000-000000000116',
    name: 'VFD — Reformer Feed',
  ...
  {
    id: '82000000-0000-0000-0000-000000000117',
    name: 'VFD — Recycle Compressor',
  ...
  {
    id: '82000000-0000-0000-0000-000000000118',
    name: 'Motor Protection Relay — Group A',
  ...
  {
    id: '82000000-0000-0000-0000-000000000119',
    name: 'Motor Protection Relay — Group B',
  ...
  {
    id: '82000000-0000-0000-0000-000000000120',
    name: 'Motor Protection Relay — Group C',
    desc: 'Intelligent motor protection relay group for Alkylation and Utilities area motors.',
    type: 'other',
    crit: 'business_critical',
    vendor: 'ABB',
    model: 'REF615 Protection Relay',
    fw: 'V2.1.3',
    ip: '10.10.1.57',
    net: 'OT-PLC-VLAN10',
    purdueLevel: 1,
  ...
  {
    id: '82000000-0000-0000-0000-000000000121',
    name: 'SIL 2 Logic Solver — Flare',
  ...
  {
    id: '82000000-0000-0000-0000-000000000122',
    name: 'SIL 2 Logic Solver — Blowdown',
  ...
  {
    id: '82000000-0000-0000-0000-000000000123',
    name: 'SIL 3 Logic Solver — ESD',
  ...
  {
    id: '82000000-0000-0000-0000-000000000124',
    name: 'SIL 3 Logic Solver — F&G',
  ...
  {
    id: '82000000-0000-0000-0000-000000000125',
    name: 'PLC Network Switch — VLAN 10',
  ...
  {
    id: '82000000-0000-0000-0000-000000000126',
    name: 'PLC Network Switch — VLAN 15',
  ...
  {
    id: '82000000-0000-0000-0000-000000000128',
    name: 'Remote I/O — Hydrocracker',
...
const L0_ASSETS: AssetDef[] = [
  {
    id: '82000000-0000-0000-0000-000000000129',
    name: 'Temperature Transmitter — CDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000130',
    name: 'Pressure Transmitter — CDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000131',
    name: 'Flow Transmitter — CDU',
    desc: 'Coriolis mass flow transmitter measuring crude oil feed rate.',
    type: 'sensor',
    crit: 'safety_critical',
    vendor: 'Emerson',
    model: 'Micro Motion 5700',
    fw: 'V3.2.1',
    net: 'OT-FIELD-VLAN05',
    purdueLevel: 0,
    zoneId: '71000000-0000-0000-0000-000000000006',
  ...
  {
    id: '82000000-0000-0000-0000-000000000132',
    name: 'Level Transmitter — CDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000133',
    name: 'Temperature Transmitter — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000134',
    name: 'Pressure Transmitter — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000135',
    name: 'Flow Transmitter — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000136',
    name: 'Level Transmitter — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000137',
    name: 'Temperature Transmitter — Hydrocracker',
  ...
  {
    id: '82000000-0000-0000-0000-000000000138',
    name: 'Pressure Transmitter — Hydrocracker',
  ...
  {
    id: '82000000-0000-0000-0000-000000000139',
    name: 'Flow Transmitter — Hydrocracker',
  ...
  {
    id: '82000000-0000-0000-0000-000000000140',
    name: 'Temperature Transmitter — Reformer',
  ...
  },
  {
    ...
    name: 'Pressure Transmitter — Reformer',
  ...
  {
    id: '82000000-0000-0000-0000-000000000142',
    name: 'Flow Transmitter — Reformer',
    ...
    meta: {
      protocol: 'HART',
      measurement: 'volumetric_flow',
      accuracy: '±0.5%',
      patchLevel: '2025-Q2',
    },
  },
  {
    id: '82000000-0000-0000-0000-000000000143',
    name: 'Control Valve — CDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000144',
    name: 'Control Valve — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000145',
    name: 'Control Valve — Hydrocracker',
  ...
  {
    id: '82000000-0000-0000-0000-000000000146',
    name: 'Control Valve — Reformer',
  ...
  {
    id: '82000000-0000-0000-0000-000000000147',
    name: 'Control Valve — Alkylation',
  ...
  {
    id: '82000000-0000-0000-0000-000000000151',
    name: 'Analyzer — Crude Assay',
  ...
  {
    id: '82000000-0000-0000-0000-000000000152',
    name: 'Analyzer — Product Quality',
  ...
  {
    id: '82000000-0000-0000-0000-000000000153',
    name: 'Analyzer — Sulfur Content',
  ...
  {
    id: '82000000-0000-0000-0000-000000000154',
    name: 'Positioner — CDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000155',
    name: 'Positioner — VDU',
  ...
  {
    id: '82000000-0000-0000-0000-000000000156',
    name: 'Positioner — Hydrocracker',
  ...
  {
    id: '82000000-0000-0000-0000-000000000157',
    name: 'Positioner — Reformer',
  ...
  {
    id: '82000000-0000-0000-0000-000000000158',
    name: 'Vibration Sensor — Compressor',
  ...
  {
    id: '82000000-0000-0000-0000-000000000159',
    name: 'Vibration Sensor — Pump',
  ...
  {
    id: '82000000-0000-0000-0000-000000000160',
    name: 'Vibration Sensor — Motor',
  ...
  {
    id: '82000000-0000-0000-0000-000000000161',
  ...
  {
    id: '82000000-0000-0000-0000-000000000163',
    name: 'Flame Detector — Furnace',
...
const COMMUNICATION_RULES = [
  // L5 ↔ L4: Enterprise to Business Planning
  {
    ...
    isAllowed: true,
    protocol: 'HTTPS, SMB',
    condition: 'Authenticated via AD, no direct OT data access',
  },
  {
    sourceLevelId: L.L4,
    targetLevelId: L.L5,
    isAllowed: true,
    protocol: 'HTTPS',
    condition: 'Business data only, no OT real-time data',
  },

  // L5 ↔ L3.5: Enterprise to iDMZ (strictly controlled)
  {
    sourceLevelId: L.L5,
    targetLevelId: L.L3_5,
    isAllowed: true,
    protocol: 'HTTPS, RDP',
    condition: 'Via jump server only, MFA required, session recorded',
  },
  {
    sourceLevelId: L.L5,
    targetLevelId: L.L3_5,
    isAllowed: false,
    protocol: 'Any',
    condition: 'Direct access from enterprise to iDMZ without jump server — prohibited',
  },
  ...
  // L4 ↔ L3.5: Business Planning to iDMZ
  {
    ...
    targetLevelId: L.L3_5,
    isAllowed: true,
    protocol: 'HTTPS, OPC UA',
    condition: 'Historian data replication via data diode (OT→IT only)',
  },
  {
    sourceLevelId: L.L4,
    targetLevelId: L.L3_5,
    isAllowed: false,
    protocol: 'Any',
    condition: 'IT systems must not initiate connections to OT — only via data diode',
  },

  // L3.5 ↔ L3: iDMZ to Operations (controlled)
  {
    sourceLevelId: L.L3_5,
    targetLevelId: L.L3,
    isAllowed: true,
    protocol: 'HTTPS, OPC UA, RDP',
    condition: 'Via jump server, patch management, or OPC UA gateway only',
  },
  {
    sourceLevelId: L.L3,
    targetLevelId: L.L3_5,
    isAllowed: true,
    protocol: 'HTTPS, OPC UA, Syslog',
    condition: 'Historian replication, log forwarding, and AV updates',
  },
  {
    sourceLevelId: L.L3_5,
    targetLevelId: L.L3,
    isAllowed: false,
    protocol: 'Any',
    condition: 'Unauthenticated access from iDMZ to OT — prohibited',
  },
  ...
  // L3 ↔ L2: Operations to Supervisory
  {
    ...
    targetLevelId: L.L2,
    isAllowed: true,
    protocol: 'OPC UA, PROFINET, Modbus/TCP',
    condition: 'Supervisory control and data acquisition',
  },
  {
    sourceLevelId: L.L2,
    targetLevelId: L.L3,
    ...
    condition: 'Process data aggregation and reporting',
  },
  ...
  // L2 ↔ L1: Supervisory to Basic Control
  {
    ...
    condition: 'Control commands and I/O data',
  },
  {
    sourceLevelId: L.L1,
    targetLevelId: L.L2,
    ...
    condition: 'Process variable and status data',
  },
  ...
  // L1 ↔ L0: Basic Control to Process
  {
    ...
    targetLevelId: L.L0,
    isAllowed: true,
    protocol: '4-20mA, HART, Foundation Fieldbus',
    condition: 'Hardwired I/O and fieldbus communication',
  },
  {
    sourceLevelId: L.L0,
    targetLevelId: L.L1,
    ...
    condition: 'Sensor data and actuator feedback',
  },
  ...
  // Cross-boundary restrictions (prohibited)
  {
    ...
    protocol: 'Any',
    condition:
      'Direct enterprise-to-OT communication — must traverse iDMZ per IEC 62443-3-3 SR 5.1',
  },
  {
    sourceLevelId: L.L5,
    targetLevelId: L.L2,
    isAllowed: false,
    protocol: 'Any',
    condition: 'Enterprise must not access supervisory layer directly',
  },
  {
    sourceLevelId: L.L5,
    targetLevelId: L.L1,
    isAllowed: false,
    protocol: 'Any',
    condition: 'Enterprise must not access control layer directly',
  },
  {
    sourceLevelId: L.L5,
    targetLevelId: L.L0,
    isAllowed: false,
    protocol: 'Any',
    condition: 'Enterprise must not access field devices directly',
  },
  {
    sourceLevelId: L.L4,
    targetLevelId: L.L3,
    isAllowed: false,
    protocol: 'Any',
    condition: 'Business planning must not access OT directly — must traverse iDMZ',
  },
  {
    sourceLevelId: L.L4,
    targetLevelId: L.L1,
    isAllowed: false,
    protocol: 'Any',
    condition: 'Business planning must not access control layer directly',
  },
  {
    sourceLevelId: L.L3,
    targetLevelId: L.L5,
    isAllowed: false,
    protocol: 'Any',
    condition: 'OT must not initiate connections to enterprise — data flows via iDMZ only',
  },
  {
    sourceLevelId: L.L3,
    targetLevelId: L.L4,
    isAllowed: false,
    protocol: 'Any',
    condition: 'OT must not initiate connections to business planning — data flows via iDMZ only',
  },
  {
    sourceLevelId: L.L1,
    targetLevelId: L.L3,
    isAllowed: false,
    protocol: 'Any',
    condition: 'PLC must not bypass supervisory layer to reach operations',
  },
  {
    sourceLevelId: L.L0,
    targetLevelId: L.L3,
    isAllowed: false,
    protocol: 'Any',
    condition: 'Field devices must not communicate beyond their assigned PLC',
  },
];
...
async function seed() {
  ...
  for (const mapping of ASSET_MAPPINGS) {
    await tenantDb
      .insert(tenantSchema.assetMappings)
      .values({
        modelId: PURDUE_MODEL.id,
  ...
  for (const rule of COMMUNICATION_RULES) {
    await tenantDb
      .insert(tenantSchema.communicationRules)
      .values({
        modelId: PURDUE_MODEL.id,
  ...
  console.log(
    `  L5  Enterprise Network:      ${L5_ASSETS.length} new + 0 existing = ${L5_ASSETS.length}`,
  );
  console.log(
    `  L4  Business Planning:        ${L4_ASSETS.length} new + 0 existing = ${L4_ASSETS.length}`,
  );
  console.log(
    `  L3.5 Industrial DMZ:          ${L3_5_ASSETS.length} new + 3 existing = ${L3_5_ASSETS.length + 3}`,
  );
  console.log(
    `  L3  Operations:               ${L3_ASSETS.length} new + 4 existing = ${L3_ASSETS.length + 4}`,
  );
  console.log(
    `  L2  Supervisory:              ${L2_ASSETS.length} new + 0 existing = ${L2_ASSETS.length}`,
  );
  console.log(
    `  L1  Basic Control:            ${L1_ASSETS.length} new + 3 existing = ${L1_ASSETS.length + 3}`,
  );
  console.log(
    `  L0  Process:                  ${L0_ASSETS.length} new + 1 existing = ${L0_ASSETS.length + 1}`,
  );
  console.log('');
